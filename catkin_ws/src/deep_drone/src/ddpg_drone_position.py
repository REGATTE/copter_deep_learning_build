...
#
    ...
    saved_path = '/home/user/catkin_ws/src/deep_drone/src/Data_Saved' #/Model_Weights_saved'
    save_directory = os.path.join(os.getcwd(), saved_path)

    try:
        actor.model.load_weights("/home/user/catkin_ws/src/deep_drone/src/Data_Saved/Actor_weights/499_actor_weights.h5")
        actor.model_target.load_weights("/home/user/catkin_ws/src/deep_drone/src/Data_Saved/Actor_weights/499_actor_weights.h5")
        critic.model.load_weights('/home/user/catkin_ws/src/deep_drone/src/Data_Saved/Critic_weights/499_critic_model.h5')
        critic.model_target.load_weights("/home/user/catkin_ws/src/deep_drone/src/Data_Saved/Critic_weights/499_critic_model.h5")
...
#            print('ERROR: Model weight not succesfully')
        ...
        actor = ActorNetwork(env,sess)
        #critic = CriticNetwork(env,sess)
        #actor_model = '/home/user/catkin_ws/src/deep_drone/src/Data_Saved/Actor_weights/%d_actor_model.h5' %(i) QUESTO È QUELLO ORIGINALE
        actor_model = '/home/user/catkin_ws/src/deep_drone/src/Data_Saved/Actor_weights/499_actor_model.h5'
